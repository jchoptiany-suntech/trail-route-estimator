create or replace function public.persist_route_estimation_bundle(
  ...
  p_history_version integer,
  p_recomputed_from_history_id bigint,
  p_history_legacy_flag boolean,
  ...
  p_planned_run_timezone_offset_minutes integer
)
returns void
language plpgsql
security invoker
...
begin
  ...
  values (
    ...
    p_profile_signature,
    p_history_version,
    p_recomputed_from_history_id,
    p_history_legacy_flag,
    p_source_file_name,
    p_total_distance_m,
    p_elevation_gain_m,
    p_planned_run_at,
    p_planned_run_timezone_offset_minutes,
    p_estimated_time_minutes,
    p_difficulty,
    p_average_slope_percent,
    p_effort_score,
